...
`maestronemeton` was previously distributed under the MIT license. It has
...
classifier whose raster outputs `nemeton` consumes as data, not as linked
code). See ADR-015 in `nemetonplateform`.
